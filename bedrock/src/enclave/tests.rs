...
// Failure cases
#[test]
// This test uses a valid CBOR/COSE structure but with certificates
// signed by a different root CA to test certificate chain validation

// Create a minimal valid CBOR array structure that looks like an attestation
// but will fail certificate validation due to untrusted root
fn test_attestation_with_untrusted_root_ca() {
    let fake_attestation_doc_base64 = "";

    let attestation_doc_bytes = base64::Engine::decode(
        &base64::engine::general_purpose::STANDARD,
        fake_attestation_doc_base64,
    )
    .expect("Failed to decode base64");
    ...
    let verifier = EnclaveAttestationVerifier::new_with_config_and_time_skip(
        vec![], // Cert validation happens before PCR validation so we dont really need this
        root_cert.to_vec(),
        60000,
        true,
    );

    // This should fail with certificate chain validation error
    let result = verifier.verify_attestation_document(&attestation_doc_bytes);

    match result {
        Err(EnclaveAttestationError::AttestationChainInvalid(_)) => {
            // This is the expected error - certificate chain validation should fail
            println!("✅ Correctly rejected attestation with untrusted root CA");
        }
        Ok(_) => {
            panic!("❌ Test failed: Should have rejected attestation with untrusted root CA");
        }
        Err(other_error) => {
            panic!("❌ Test failed with unexpected error: {:?}", other_error);
        }
    }
}

#[test]
fn test_invalid_cbor_magic_bytes() {
    let invalid_data = vec![0x00, 0x01, 0x02, 0x03]; // Not a valid CBOR array

    let verifier = EnclaveAttestationVerifier::new_with_config_and_time_skip(
        vec![],
        super::constants::AWS_NITRO_ROOT_CERT_PROD.to_vec(),
        60000,
        true,
    );

    let result = verifier.verify_attestation_document(&invalid_data);

    match result {
        Err(EnclaveAttestationError::AttestationDocumentParseError(msg)) => {
            assert!(msg.contains("Invalid CBOR magic byte"));
            println!("✅ Correctly rejected data with invalid CBOR magic bytes");
        }
        other => {
            panic!("❌ Expected CBOR magic byte error, got: {:?}", other);
        }
    }
}

#[test]
fn test_mismatched_pcrs() {
    let attestation_doc_base64 = "";
    ...
    verifier.add_allowed_pcr_config(PcrConfiguration {
        index: 0,
        expected_value: hex::decode(
            "ab6111e5a72a5bfb60ae394baabbe1f0000046ce13f7f2f67fd69e1e212ba90fe53af95a01b9eee9e722795d06406b5d",
        )
        .unwrap(),
        description: "Bad PCR enclave image v1.0.0-staging".to_string(),
    });
    verifier.add_allowed_pcr_config(PcrConfiguration {
        index: 1,
        expected_value: hex::decode(
    ...
    match result {
        Err(EnclaveAttestationError::CodeUntrusted { pcr_index, actual }) => {
            ...
            println!(
                "✅ Correctly rejected attestation with mismatched PCR{}: {}",
                pcr_index, actual
            );
        }
        other => {
            panic!("❌ Expected CodeUntrusted error, got: {:?}", other);
        }
    }
}
...
fn test_expired_certificate() {
    ...
    match result {
        Err(EnclaveAttestationError::AttestationChainInvalid(msg)) => {
            assert!(msg.contains("CertExpired") || msg.contains("expired"));
            println!("✅ Correctly rejected expired certificate: {}", msg);
        }
        Ok(_) => {
            panic!("❌ Test failed: Should have rejected expired certificate");
        }
        Err(other_error) => {
            panic!("❌ Test failed with unexpected error: {:?}", other_error);
        }

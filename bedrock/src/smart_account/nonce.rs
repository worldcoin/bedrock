...
//! [0]        : typeId (1 byte)
//! [1..=5]    : magic: currently "bdrck" (5 bytes) -- this is used to identify transactions generated by Bedrock
...
static MAGIC_V1_CONST: &[u8; 5] = b"bdrck";
...
impl NonceKeyV1 {
    ...
    fn as_bytes(&self) -> [u8; 24] {
        ...
        // [1..=5] magic
        out[1..=5].copy_from_slice(MAGIC_V1_CONST);
        // [6] instruction flags

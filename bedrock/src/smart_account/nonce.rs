...
//! [1..=5]    : magic: currently "bdrck" or "pbhtx" (5 bytes) -- this is used to identify transactions generated by Bedrock
//! [6]        : typeId (1 byte)
//! [7]        : instruction flags (1 byte)
//! [8..=17]   : metadata (10 bytes) - type-specific metadata
//! [18..=24]  : random tail (7 bytes)
//! [25..=32]  : sequence (8 bytes) - usually 0 for Bedrock crafted txs

...
#[uniffi::export]
pub fn demo_authenticate(username: &str, password: &str) -> Result<String, DemoError> {
...
#[uniffi::export]
pub fn demo_generic_operation(input: &str) -> Result<String, DemoError> {
...
#[uniffi::export]
pub fn demo_mixed_operation(operation: &str, data: &str) -> Result<String, DemoError> {
...
mod tests {
    ...
    fn test_demo_mixed_operation() {
        // Test success case
        let result = demo_mixed_operation("process", "valid_data");
        assert!(result.is_ok());
        assert!(result.unwrap().contains("Processed:"));

        // Test strongly typed error - empty operation
        let result = demo_mixed_operation("", "data");
        ...
        let result = demo_mixed_operation("unknown", "data");
        assert!(result.is_err());
        if let Err(DemoError::InvalidInput { message }) = result {
        ...
        let result = demo_mixed_operation("process", "trigger_error");
        assert!(result.is_err());

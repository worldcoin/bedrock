...
- ERC-4626 vault-to-vault migrate (`transaction_erc4626_migrate`) with `previewRedeem` snapshot, 0.03% deposit haircut, source `maxRedeem` cap, destination `previewDeposit > 0` guard, and zero-first approve when needed

...
public protocol SafeSmartAccountProtocol: AnyObject, Sendable {
     ...
     */
    func personalSign(chainId: UInt32, message: String) throws  -> String
...
public convenience init(ethereumKey: String, walletAddress: String)throws  {
     ...
     * - Will throw an error if the signature process unexpectedly fails.
     */
open func personalSign(chainId: UInt32, message: String)throws  -> String  {
 ...
 */
public func demoAuthenticate(username: String, password: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeDemoError_lift) {
    uniffi_bedrock_fn_func_demo_authenticate(
 ...
 */
public func demoGenericOperation(input: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeDemoError_lift) {
    uniffi_bedrock_fn_func_demo_generic_operation(
 ...
 */
public func demoMixedOperation(operation: String, data: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeDemoError_lift) {
    uniffi_bedrock_fn_func_demo_mixed_operation(
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_bedrock_checksum_func_demo_authenticate() != 45938) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bedrock_checksum_func_demo_generic_operation() != 42555) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bedrock_checksum_func_demo_mixed_operation() != 65503) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bedrock_checksum_method_safesmartaccount_personal_sign() != 38083) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_bedrock_checksum_constructor_safesmartaccount_new() != 8267) {
        return InitializationResult.apiChecksumMismatch
    }
